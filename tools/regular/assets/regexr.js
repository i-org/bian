var regexr = function() {
        ...
        Va.prototype.onContextMenu = function(e) {
            ...
            function n() {
                ...
                null != s.selectionStart) {
                    ...
                    var e = 0
                      , n = function() {
                        o.selForContextMenu == i.doc.sel && 0 == s.selectionStart && s.selectionEnd > 0 && "â€‹" == r.prevInput ? dr(i, Li)(i) : e++ < 10 ? o.detectingSelectAll = setTimeout(n, 500) : (o.selForContextMenu = null,
                        o.input.reset())
                    };
            ...
            set: function(e) {
                if (e !== this._example) {
                    ...
                    n && i)) {
                        ...
                        t += "<hr><code class='text'><svg class='icon load'><use xlink:href='#load'><title>Load text</title></use></svg>" + s + (o ? "<i>â€¦</i>" : "") + "</code>"
                    }
                    this.el.innerHTML = t,
      ...
      , Y = function() {
        ...
        return i(e, [{
            ...
            value: function(e) {
                ...
                0 === e.results.length && this._showListMsg("community" === this.curItem.id ? "无匹配." : "No patterns created or favorited.")
            }
        }, {
            key: "_reqCleanup",
            value: function(e) {
    ...
    ee.kids = [{
        ...
        kids: [{
            ...
            id: "whitespace",
            desc: "匹配任意空格字符 (spaces, tabs, line breaks).",
            example: ["\\s", "glib jocks vex dwarves!"],
            token: "\\s"
        }, {
            id: "notwhitespace",
            label: "not whitespace",
            desc: "匹配任意非空格字符 (spaces, tabs, line breaks).",
            example: ["\\S", "glib jocks vex dwarves!"],
            token: "\\S"
        }, {
            id: "hwhitespace",
        ...
        return i(e, [{
            ...
            value: function(e, t) {
                ...
                if (window.Worker) {
                    ...
                    var o = this._worker = new Worker("assets/RegExWorker.js");
